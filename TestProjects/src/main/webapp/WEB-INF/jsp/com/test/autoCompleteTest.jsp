...
<div style="height:500px; border:1px solid gray;">
	SELECT2: <select id="fruitCombo" style="height:100px; margin-left: 20px; width: 500px" class="form-control input-sm">	
				<option value="">선택</option>
		        <option value="fruit1" style="height:100px;">사과<br>안녕하세요</option>
		        <option value="fruit2">수박</option>
